...
module "example" {
  ...
  "127.1.0.1/27, 1.1.1.1/27"
  	 ...
  	 ebs_size  = 100
  	 ec2_egress_cidr_blocks  = [
  "127.1.0.1/27, 1.1.1.1/27"
]
  	 ec2_ingress_cidr_blocks  = [
  "127.1.0.1/27, 1.1.1.1/27"
]
  	 environment  = "int"
  	 instance_count  = 1
...
|------|-------------|------|---------|:--------:|
| <a name="input_alb_ingress_cidr_blocks"></a> [alb\_ingress\_cidr\_blocks](#input\_alb\_ingress\_cidr\_blocks) | CIDR blocks for ALB security group ingress. | `list(string)` | <pre>[<br>  "127.1.0.1/27, 1.1.1.1/27"<br>]</pre> | no |
...
| <a name="input_ec2_egress_cidr_blocks"></a> [ec2\_egress\_cidr\_blocks](#input\_ec2\_egress\_cidr\_blocks) | CIDR blocks for EC2 security group egress. | `list(string)` | <pre>[<br>  "127.1.0.1/27, 1.1.1.1/27"<br>]</pre> | no |
| <a name="input_ec2_ingress_cidr_blocks"></a> [ec2\_ingress\_cidr\_blocks](#input\_ec2\_ingress\_cidr\_blocks) | CIDR blocks for EC2 security group ingress. | `list(string)` | <pre>[<br>  "127.1.0.1/27, 1.1.1.1/27"<br>]</pre> | no |
