...
module "example" {
  ...
  },
  {
    ...
    "to_port": 443
  	 ...
  	 ebs_size  = 40
  	 environment  = "int"
  	 hosted_zone_id  = "Z026893033NQ8DKXNWP5G"
...
| <a name="input_hosted_zone_id"></a> [hosted\_zone\_id](#input\_hosted\_zone\_id) | The id of Hosted Zone | `string` | `"Z026893033NQ8DKXNWP5G"` | no |
...
| <a name="output_subdomain_url"></a> [subdomain\_url](#output\_subdomain\_url) | Output the IDs of the fetched subnets for use in other configurations |
